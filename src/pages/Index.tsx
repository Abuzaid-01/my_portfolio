...
const Index = () => {
  ...
  return (
    <div className="min-h-screen scanlines grain vignette relative selection:bg-primary/20">
      ...
      {/* ── NAV ── */}
      <nav className="fixed top-0 left-0 right-0 z-40 backdrop-blur-md bg-background/50 border-b border-border/60">
        <div className="max-w-7xl mx-auto px-6 md:px-10 h-14 flex items-center justify-between">
          <a href="#home" className="font-mono text-sm tracking-[0.35em] text-primary text-glow-sm font-medium">
            ABUZAID<span className="text-foreground/40 text-xs">::dev</span>
          </a>

          {/* Desktop nav */}
          <div className="hidden md:flex items-center gap-7 font-mono text-xs">
            {NAV.map((n) => (
              <a key={n.n} href={n.href} className="terminal-link flex items-center gap-1.5">
        ...
        {/* Mobile drawer */}
        {menuOpen && (
          <div className="md:hidden border-t border-border/60 bg-background/95 backdrop-blur-xl px-6 py-4 flex flex-col gap-4 font-mono text-sm animate-fade-in">
            {NAV.map((n) => (
              <a
                key={n.n}
                href={n.href}
      ...
      <section id="home" className="relative min-h-screen flex items-center overflow-hidden pt-14">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 w-full grid lg:grid-cols-2 gap-10 lg:gap-16 items-center relative z-10">
          ...
          <div className="animate-fade-up" style={{ animationDelay: "0.05s" }}>
            ...
            {/* Terminal breadcrumb */}
            <div className="flex items-center gap-3 font-mono text-xs text-primary/70 mb-8">
              <span className="w-12 h-px bg-primary/50" />
              <span className="text-glow-sm tracking-widest">~/portfolio $ ./init —— ready</span>
            </div>

            {/* WHOAMI label */}
            <div className="font-mono text-sm md:text-base text-muted-foreground/60 mb-3 tracking-[0.15em]">
              whoami →
            </div>
            ...
            <div className="font-mono text-sm sm:text-base md:text-lg text-foreground/70 mb-4 flex items-baseline gap-2 flex-wrap">
            ...
            {/* Sub-headline */}
            <p className="font-mono text-sm md:text-base text-muted-foreground mb-10 max-w-xl leading-relaxed">
              <span className="text-primary">›</span>{" "}
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
              <a
                href="#work"
                className="inline-flex items-center gap-2 px-6 py-3.5 bg-primary text-primary-foreground font-mono text-xs uppercase tracking-[0.25em] hover:bg-primary/90 transition-all duration-300 hover:scale-105"
              ...
              <a
                href="#journey"
                className="inline-flex items-center gap-2 px-6 py-3.5 border border-primary/40 font-mono text-xs uppercase tracking-[0.25em] hover:border-primary hover:text-primary hover:bg-primary/5 transition-all duration-300"
              >
                ./journey
              </a>
              <a
                href="#contact"
                className="inline-flex items-center gap-2 px-6 py-3.5 border border-border font-mono text-xs uppercase tracking-[0.25em] hover:border-primary/60 hover:text-primary/80 transition-all duration-300"
              >
                ./contact
              </a>
            </div>
